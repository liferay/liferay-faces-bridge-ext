 ...
 * @author  Neil Griffin
 */
public class PartialViewContextFactoryLiferayImpl extends PartialViewContextFactory {

	// Private Data Members
	private PartialViewContextFactory wrappedPartialViewContextFactory;

	public PartialViewContextFactoryLiferayImpl(PartialViewContextFactory partialViewContextFactory) {
	...
	public PartialViewContext getPartialViewContext(FacesContext facesContext) {
		...
		return new PartialViewContextLiferayImpl(wrappedPartialViewContext, facesContext);
	}
